function ShapeContainer(config) {
    ...
    this.getScore = function (sx, sy) {
        if (config.isOnScoreBoard(sx, sy)) {
            // Directly changing an attribute of an injected dependency is NOT good practice. We can this modification
            // "mutation". Mutations are generally bad and should be avoided just as global and instance variables.
